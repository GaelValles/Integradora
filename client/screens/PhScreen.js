  ...
  return (
    <View>
      <View style={styles.header}>
        <TouchableOpacity>
          <Image source={flecha} style={styles.atras} />
        </TouchableOpacity>
        <TouchableOpacity>
    ...
    <View style={styles.bottomTab}>
        <TouchableOpacity>
          <Image source={ventas} style={styles.bottomIcon1} />
        </TouchableOpacity>
        <TouchableOpacity>
          <Image source={ph} style={styles.bottomIcon2} />
        </TouchableOpacity>
        <TouchableOpacity>
          <Image source={home} style={styles.bottomIcon3} />
        </TouchableOpacity>
        <TouchableOpacity>
          <Image source={dureza} style={styles.bottomIcon4} />
        </TouchableOpacity>
        <TouchableOpacity>
          <Image source={flujo} style={styles.bottomIcon5} />
        </TouchableOpacity>
    </View>
    </View>
  );
